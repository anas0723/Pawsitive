    ...
    <section className="mb-10">
      <div className="bg-white shadow-2xl rounded-2xl  flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 py-8 md:py-0 md:pl-10 md:pr-4">
          ...
          <button className="font-poppins w-fit px-6 py-2 rounded-full bg-[#FF8B71] text-white font-semibold shadow hover:bg-[#ff6a3d] transition-colors duration-200 text-base mb-[44px]">Become An Ambassador</button>
        </div>
        {/* Right Side */}
