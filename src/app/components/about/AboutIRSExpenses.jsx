  ...
  return (
    <section className="w-full py-10 bg-white">
      <div className="max-w-7xl mx-auto w-full px-4">
        ...
        <div className="relative flex flex-col md:flex-row items-center md:items-start gap-8 min-h-[260px] bg-[#FFFDFD]">
          ...
          <div className="w-full md:w-auto md:absolute md:left-[calc(240px+115px)] md:top-1/2 md:-translate-y-1/2 z-20">
            <div className="bg-[#FFFDFD] shadow-2xl rounded-xl  p-6 flex flex-col gap-2 max-w-md w-full">
              <h3 className="font-poppins font-bold text-lg text-[#222] mb-2">Food And Nutrition</h3>
              <ul className="font-poppins text-[15px] text-[#000] mb-3 list-disc list-inside">
                <li>Pet food (dry, wet, and specialty diets)</li>
                <li>Nutritional supplements and vitamins</li>
              </ul>
              <button className={CTA_BUTTON_CLASSES + ' w-[167px] h-[52px] rounded-[16px] border-4 px-[28px] py-[14px] flex items-center justify-center gap-[10px] text-base'}>Join us</button>
            </div>
          </div>
        </div>
      </div>
