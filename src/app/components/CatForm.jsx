...
const CatForm = () => {
  return (
    <section className="relative flex items-end min-h-[420px] w-full overflow-hidden bg-[#FFF6E9] p-0">
      {/* Cat main image with paw print overlay */}
      <div className="relative min-w-[340px] h-[420px] flex items-end z-20">
        <Image
      ...
      {/* Form and paw print bg */}
      <div className="flex-1 flex flex-col items-center justify-center relative z-30 min-h-[420px]">
        <div className="relative w-full max-w-[420px] pt-8">
          ...
          <form className="flex flex-wrap gap-3 justify-center relative z-40">
            <input
              ...
              className="flex-1 min-w-[120px] border border-[#E0E0E0] rounded-lg px-3 py-2 text-sm bg-white"
              required
            />
            <input
              type="text"
            ...
            <input
              type="text"
              placeholder="Subject"
              className="w-full border border-[#E0E0E0] rounded-lg px-3 py-2 text-sm bg-white"
              required
            />
            <textarea
              placeholder="Message"
              className="w-full border border-[#E0E0E0] rounded-lg px-3 py-2 text-sm bg-white min-h-[60px] resize-vertical"
              required
            />
            <button
              type="submit"
              className="w-full bg-[#FF5A5F] text-white rounded-lg py-3 font-bold text-base mt-2 shadow-md hover:bg-[#e14c4f] transition-colors"
            >
              Submit
            </button>
          </form>
