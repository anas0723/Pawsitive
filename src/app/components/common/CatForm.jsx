...
const CatForm = () => {
  return (
    <section className="relative w-full min-h-[420px] flex items-end justify-center overflow-hidden bg-[#FFF6E9] p-0">
      {/* Top pink curve */}
      <Image
        ...
        width={1600}
        height={180}
        className="absolute top-0 left-0 w-full h-[120px] object-cover z-0"
        priority
      />
      ...
      <Image
        ...
        width={600}
        height={400}
        className="absolute right-0 bottom-0 w-[60%] h-[80%] object-contain opacity-40 z-0 pointer-events-none"
      />
      {/* Cat image left */}
      <div className="relative z-10 flex-1 flex justify-end items-end min-w-[260px] max-w-[340px] h-[420px]">
        <Image
        ...
        <Image
          ...
          width={120}
          height={120}
          className="absolute left-0 bottom-0 w-[90px] h-[90px] object-contain opacity-70 z-20"
        />
      </div>
      {/* Form section */}
      <div className="relative z-20 flex-1 flex flex-col items-center justify-center min-h-[420px] w-full max-w-xl px-4">
        <h2 className="font-bold text-2xl mb-6 text-center text-[#222] leading-snug">
          Let's Make A Pawsitive<br />Change, Together!
        </h2>
        <form className="flex flex-wrap gap-3 justify-center w-full">
          <input
            type="text"
